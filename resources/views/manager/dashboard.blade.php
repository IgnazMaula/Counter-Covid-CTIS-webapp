                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Number of Registered Tester</div>
                                            @php
                                                $registered = 0;
                                            @endphp
                                            @foreach ($tester as $key => $data)
                                                @if ($data->role == 'tester' and $data->testCenter == Auth::user()->testCenter)
                                                    @php
                                                        $registered += 1;
                                                    @endphp
                                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark">Details About Your Test Center</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <table ble class="table table-borderless">
